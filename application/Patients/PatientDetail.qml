    ...
    Flickable {
        ...
        Column {
            ...
            Column {
                ...
                Text {
                    width: parent.width
                    text: "Deleting a patient permanently removes their account and all associated records. This cannot be undone."
                    font.pixelSize: 13
                    color: Theme.onSurfaceVariant
                    wrapMode: Text.WordWrap
                }
                        ...
                        MouseArea {
                            ...
                            onReleased: {
                                ...
                                if (deleteThumb.x >= slideToDelete.maxX * 0.9) {
                                    ...
                                    Sfx.playBack();
                                    ApiClient.del("/patients/" + root.patientId, "deletePatient:" + root.patientId);
                                } else {
                                    deleteThumb.x = slideToDelete.trackMargin;
                                }
                            }
